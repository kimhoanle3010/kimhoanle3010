...
host = "a546a20avkgys-ats.iot.us-west-2.amazonaws.com"
...
my_rpi.configureConnectDisconnectTimeout(100)  # 10 sec
my_rpi.configureMQTTOperationTimeout(50)  # 5 sec

# Connect and subscribe to AWS IoT
my_rpi.connect()
my_rpi.subscribe("Iot_Garden/readings", 1, customCallback)
...
while True:
  ...
  message["light"] = light
  import json
  my_rpi.publish("Iot_Garden/readings", json.dumps(message), 1)
